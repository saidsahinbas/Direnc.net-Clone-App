...
namespace TestProject.Services
{
    public class ProductServiceTests
    {
        ...
        {
            var response = await _productservice.GetAsync(5);
            Assert.NotNull(response);
        ...
        {
            var response = await _productservice.GetAsync(50);
        ...
        {
            var response = await _productservice.ListAsync(1);
            Assert.NotNull(response);
        ...
        {
            var response = await _productservice.ListAsync(5,2);
            Assert.NotNull(response);
            Assert.Equal(response, list3);
        }

        [Fact]
        public async Task Should_Return_Product_For_MainCategoryId_And_Sub1CategoryId_And_Sub2CategoryId()
        {
            var response = await _productservice.ListAsync(4, 5, 1);
            Assert.NotNull(response);
            Assert.Equal(response, list4);
        }
